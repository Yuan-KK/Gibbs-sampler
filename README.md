...
- We repeat this process for the rest of the sequences. After the last sequence has been updated, we have obtained a new set of motifs, together with the PPM. At this point, we compute a weighted alignment score (**𝐹**). Each time when we get a new set of motifs, we compute a new **𝐹** value. **𝐹** is a measure of the quality of alignment of the motifs. The larger the **𝐹** value, the better.
